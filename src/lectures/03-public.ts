export class MyDate {
  /* by default, all methods and properties have public access. We can also use the reserved
  word 'public' to explicitly make a method or property as public */
  public year: number;
  public month: number;
  public day: number;
...
/* the problem with public properties is that we can modify them from outside the class in ways
that we don't actually expect, or that we simply don't want them to be modified: */
myDate.day = 1209;
console.log(myDate.getFormatedDate()); // 1209/4/2021
